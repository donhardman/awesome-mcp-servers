...
- 🦀 [Muvon/octocode](https://github.com/Muvon/octocode) - Rust-built semantic code indexer with GraphRAG knowledge graph and MCP server. Tree-sitter AST parsing, ast-grep structural search, code signatures view, and semantic search with LanceDB vectors. 13+ languages. Local-first, Apache 2.0.
